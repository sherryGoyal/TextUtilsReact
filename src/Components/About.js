  ...
  return (
    <div className="container" style={mode}>
        ...
        <div className="accordion-item">
            ...
            <button className="accordion-button" type="button" data-bs-toggle="collapse" style={mode} data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                Accordion Item #1
            </button>
            </h2>
    ...
    <button className="btn btn-success my-2" onClick={toggleDark}>{btnText}</button>
